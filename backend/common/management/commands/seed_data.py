...
class Command(BaseCommand):
    ...
    # Team name templates
    TEAM_NAMES = [
        ("Đội Kinh Doanh Miền Bắc", "Phụ trách các hợp đồng B2B tại Hà Nội và các tỉnh phía Bắc"),
        ("Đội Kinh Doanh Miền Nam", "Phụ trách thị trường TP. Hồ Chí Minh và Đông Nam Bộ"),
        ("Đội Chăm Sóc Khách Hàng", "Hỗ trợ sau bán hàng và triển khai dịch vụ"),
        ("Đội Marketing & Lead", "Thu hút khách hàng tiềm năng qua các kênh số"),
    ]
    ...
    DEMO_FIRST_NAMES = [
        "Minh", "Nam", "Tuấn", "Dũng", "Hoàng", "Long", "Đức", "Trọng", "Huy", "Thành",
        "Linh", "Trang", "Mai", "Hương", "Hà", "Ngọc", "Thảo", "Phương", "Anh", "Quỳnh",
        "Lan", "Vy", "Huyền", "Yến", "Thủy", "Bích", "Hạnh", "Diệp", "Tâm", "Hải"
    ]
    ...
    DEMO_COMPANIES = [
        "Công ty Cổ phần Công nghệ SmartTech Việt Nam",
        "Tập đoàn Bất động sản Địa ốc An Thịnh",
        "Công ty TNHH Giải pháp Phần mềm Tân Tiến",
        "Chuỗi Bán lẻ & Tiêu dùng VinaMart Pro",
        "Công ty CP Dược phẩm & Thiết bị Y tế Phúc Khang",
        "Nội thất & Kiến trúc Xanh GreenHome",
        "Công ty TNHH Vận tải & Logistics Sao Mai",
        "Học viện Đào tạo & Truyền thông MediaPro",
        "Công ty Dịch vụ Du lịch & Lữ hành Việt Sun",
        "Công ty TNHH Cơ khí & Chế tạo Máy Hải Hà",
        "Tập đoàn Năng lượng Tái tạo SunSolar",
        "Công ty CP Tư vấn Tài chính & Kế toán ACC",
        "Chuỗi Nhà hàng Ẩm thực Cố Đô",
        "Công ty Thời trang & May mặc Phương Đông",
        "Công ty CP Quảng cáo & Truyền thông Tương Tác",
        "Công ty TNHH Thiết bị Điện & Chiếu sáng VinaLED",
        "Công ty CP Thương mại Xuất Nhập khẩu Á Châu",
        "Viện Thẩm mỹ & Chăm sóc Sức khỏe Quốc tế Q-Beauty",
        "Công ty CP Nông sản Hữu cơ Xanh EcoFarm",
        "Công ty TNHH Dịch vụ Bảo vệ & An ninh Thăng Long"
    ]
    ...
    DEMO_STREET_NAMES = [
        "Nguyễn Huệ", "Lê Lợi", "Trần Hưng Đạo", "Hai Bà Trưng", "Phố Huế", "Hoàng Diệu",
        "Điện Biên Phủ", "Cách Mạng Tháng Tám", "Nguyễn Thị Minh Khai", "Phan Chu Trinh",
        "Võ Văn Kiệt", "Lý Thường Kiệt", "Nguyễn Văn Linh", "Bà Triệu", "Đinh Tiên Hoàng"
    ]

    # Common job titles for seeded contacts / leads.
    DEMO_JOB_TITLES = [
        "Giám đốc Kinh doanh", "Trưởng phòng Mua hàng", "Chuyên viên Tư vấn", "Giám đốc Điều hành (CEO)",
        "Trưởng nhóm Kỹ thuật", "Kế toán trưởng", "Phó Giám đốc Dự án", "Quản lý Marketing",
        "Chuyên viên Chăm sóc Khách hàng", "Chủ tịch Hội đồng Quản trị"
    ]
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            ...
            help=f"Default currency for organizations (default: VND). Choices: {', '.join(valid_currencies)}",
        )
        parser.add_argument(
            "--country",
            type=str,
            default="VN",
            help="Default country code for organizations (default: VN). Examples: US, GB, CA, AU, DE, FR, IN",
        )
